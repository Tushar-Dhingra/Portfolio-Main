	...
	class WorkSlider {
		...
		animate = () => {
			...
			workScrollState.speed =
				Math.round((this.currentPosition - this.targetPosition) * 100) /
				100; // Set Svelte Store value for the Canvas effect
			...
			<div class="details-container">
				<div class="wrapper">
						...
						<div class="wrapper">
							...
							<h6 class="caption">
								<div
									...
									out:maskSlideOut
								>
									{dataState.workData![currentActive].details
										.summary}
								</div>
							</h6>
						</div>
					...
					<div class="mid-align">
						...
						<button
							class="close-button-wrapper interactive"
					...
					<div class="bottom-align">
						...
						<div class="roles">
							<div class="wrapper">
								...
								{:else if dataState.workData![currentActive].technologies && dataState.workData![currentActive].technologies.length > 0}
									<div
										in:maskSlideIn={{ reverse: true }}
										out:maskSlideOut
									>
										<p class="descriptor">Technologies</p>
									</div>
									<ul
										in:maskSlideIn={{
											reverse: true,
										...
										out:maskSlideOut
									>
										{#each dataState.workData![currentActive].technologies as tech}
											<li>{"+ " + tech}</li>
										{/each}
									</ul>
								{/if}
