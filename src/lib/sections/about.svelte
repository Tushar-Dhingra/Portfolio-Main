		...
		<div class="content-wrapper">
			...
			<div in:maskSlideIn={{ duration: 1200, reverse: true, delay: 150 }}>
				<p class="paragraph">
					...
					full-stack development, cloud architecture, and AI feature
					integration. Skilled in designing scalable API, optimizing
					database performance and troubleshooting complex issues.
					Eager to leverage background in AI and full-cycle software
					development to contribute to a technical environment.
				</p>
			</div>
			<div class="social-button-wrapper">
				<div in:maskSlideIn={{ delay: 400, reverse: true }}>
					<span class="button"
						><a
							href="mailto:tushardhingra808@gmail.com"
							target="_blank"
				...
				<div in:maskSlideIn={{ delay: 700, reverse: true }}>
					<span class="button"
						><a
							href="https://linkedin.com/in/tushar-dhingra99"
							target="_blank"
...
<div class="horizontal-flex" bind:this={section2Element}>
	{#await sectionTwoPromise then _}
		<ul class="list first">
			...
			<li>
				<div in:letterSlideIn={{ initDelay: 550 }}>Languages</div>
				<div class="flex-item" in:maskSlideIn={{ delay: 600 }}>
					Java, Go, Python, C/C++, SQL, JS, TS, C#
				</div>
			</li>
			<li>
				<div in:letterSlideIn={{ initDelay: 650 }}>Frameworks</div>
				<div class="flex-item" in:maskSlideIn={{ delay: 700 }}>
					Node.js, Express, Nest.js, React, Next.js
				</div>
			</li>
			<li>
				<div in:letterSlideIn={{ initDelay: 750 }}>Databases</div>
				<div class="flex-item" in:maskSlideIn={{ delay: 800 }}>
					PostgreSQL, SQLite, MongoDB, MySQL, Redis
				</div>
			</li>
			<li>
				<div in:letterSlideIn={{ initDelay: 850 }}>Tools & Cloud</div>
				<div class="flex-item" in:maskSlideIn={{ delay: 900 }}>
					Git, AWS, Azure, Linux, Docker, GitLab, GitHub
				</div>
			</li>
		</ul>
		<ul class="list">
			<li class="list-title">
				<div in:letterSlideIn={{ initDelay: 400 }}>education</div>
			</li>
			<li>
