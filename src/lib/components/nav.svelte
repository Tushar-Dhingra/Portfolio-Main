			...
			<div class="wrapper" class:mobileMenuActive>
				<ul class="nav-list">
					{#key mobileMenuActive}
						...
						<li class="mobile">
							<a href="mailto:tushardhingra808@gmail.com" target="_blank" in:mobileTransitionSwitcher={{ delay: 350 }}>Contact</a>
						</li>
						<li use:introAnimation={{ delay: 1300 }}>
							<a href="https://linkedin.com/in/tushar-dhingra99" target="_blank" in:mobileTransitionSwitcher={{ delay: 400 }}>LinkedIn</a>
						</li>
					{/key}
				</ul>
			</div>
